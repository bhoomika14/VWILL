			...
			<div id="wrapper">
				...
				<!-- Header -->
					<header id="header">
						...
						<nav class="links">
							<ul>
								<li>Upcoming Activities. Come, Join Us!</li>
							</ul>
						</nav>
						<nav class="main">
							<ul>
					...
					<div id="main">
						...
						<!-- Post -->
							...
							<article class="post">
								...
								<h3>Location:
								   <a href="http://maps.google.com/?q=<?php echo $post['PLOC']; ?>" target="_blank"><?php echo $post['PLOC']; ?></a>
								</h3> 
			    	...
			    	<div class="col-6">
						...
						<!-- Footer -->
							<section id="footer">
								...
								<p class="copyright">&copy; 2020. All rights reserved by V-WILL.org</p>
							</section> 

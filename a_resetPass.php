...
<?php
    ...
    if(isset($_POST["submit"])){
        ...
        $email=$row["email"];
        $query=mysqli_query($db,"UPDATE admin SET APASS='$pw' WHERE AMAIL='$email'");
        if($query){
...
?>
    <form method="post" class="login100-form validate-form">
					...
					<div class="wrap-input100 validate-input" data-validate = "Password is required">
						<input class="input100" type="password" name="apass" placeholder="New Password" autocomplete="off">

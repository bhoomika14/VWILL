                            ...
                            <div class="card">
                              ...
                              <?php
                                    if(isset($_POST["submit"]))
                                    {
                                        ...
                                        {
                                            $sql="INSERT INTO post(PTITLE,PIMAGE,PDATE,PLOC,PBIO)VALUES('{$_POST["ptitle"]}', '{$target_file}', '{$_POST["pdate"]}','{$_POST["ploc"]}', '{$_POST["pbio"]}')";
                                                $db->query($sql);
                                                echo '<script>
                                                swal(
                                                  "Success!",
                               ...
                               ?>   
                                 ...
                                 <div class="form-group">
                                    <input type="text" class="form-control pb-3" placeholder="Enter title" name="ptitle" required>
                                   </div>   
                                 ...
                                 <div class="form-group">
                                     <div class="card">
                                       ...
                                       <div class="form-group">
                                         <input type="file" name="postImage" onchange="displayImage(this)" id="postImage" class="ml-3" required>
                                         </div>
                                     </div><!--/Card body--> 
                                   </div>
                                   ...
                                   <div class="form-group">
                                    <input type="datetime-local" class="form-control pb-3" name="pdate" required>
                                   </div>  

                                  
                                        <div class="form-group row">
                                            <input type="text" class="form-control ml-3 mr-2 pb-3 col-md-8" name="ploc" placeholder="paste URL" required><a href="https://www.google.com/maps/@12.8806812,74.8326368,14z" target="_blank" class="btn btn-outline-info col-4 col-md-3">Search Location</a>
                                        </div>  
                                     

                                   <div class="form-group">
                                     <textarea class="form-control" placeholder="Description..." name="pbio" rows=10 required></textarea>
                                   </div>   

                                


                                   <button type="submit" id="submitform" name="submit" class="btn btn-success btn-lg btn-block">POST</button>

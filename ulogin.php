		...
		<div class="container-login100">
			<div class="wrap-login100">
			   ...
			   <?php
				   ...
				   {
					   $sql="SELECT * FROM users WHERE UMAIL='{$_POST["umail"]}' AND UPASS='{$_POST["upass"]}'";
					   $res=$db->query($sql);
					   if($res->num_rows>0)
					   {
						   $row=$res->fetch_assoc();
			   ...
			   ?>    
				...
				<form action="ulogin.php" method="post" class="login100-form validate-form">
					...
					<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
						<input class="input100" type="text" name="umail" placeholder="Email" autocomplete="off">
					...
					<div class="wrap-input100 validate-input" data-validate = "Password is required">
						<input class="input100" type="password" name="upass" placeholder="Password" autocomplete="off">
						<span class="focus-input100"></span>
						<span class="symbol-input100">

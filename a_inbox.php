    ...
    <div class="wrapper">
      ...
      <div class="container content-area">
                 <div class="panel mt-5">
                     ...
                     <?php
                            $sql="SELECT users.UNAME, inbox.MAIL, inbox.SUB, inbox.MSG FROM users INNER JOIN inbox ON users.UID=inbox.UID ORDER BY inbox.QID DESC LIMIT 0,10";
                            $res=$db->query($sql);
                         ...
                         <a class="btn btn-outline-warning col-md-4" href="https://mail.google.com/mail/u/?authuser=user@gmail.com" role="button">Reply</a>
                         <a href="q_del.php?id=<?php echo $user["QID"];?>" class="btn btn-outline-warning col-md-4" id="btn-del">DELETE</a>
             ...
             <script>
				 $('#btn-del').on('click', function(e){
					 ...
					 Swal.fire({
						 ...
						 if(result.value){
							 document.location.href="q_del.php?id";
						 }
					 })
				 })
			 </script>

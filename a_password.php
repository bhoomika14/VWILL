                ...
                <div class="col-md-12">
                    ...
                    <div class="container mt-5">
                            ...
                            <div class="card col-md-6 offset-md-3">
                              <div class="card-header h2 ml-0 mr-0">Change Password</div>
                              <div class="card-body pb-5 mb-5">
                              


                                 <form action="a_password.php" method="post" enctype="multipart/form-data">
                                 <div class="form-group">
                                    <label for="opass" class="h4">Enter Old Password</label>
                                    <input type="password" name="opass" class="form-control pb-3" placeholder="old password" id="myInput" required autocomplete="off"><span class="ti-eye" onclick="myFunction()"> Show Password</span>
                                   </div>   
                                 <!--<button type="submit" class="btn btn-success mb-2 mt-2">Add</button>-->
                                   ...
                                   <div class="form-group">
                                   <label for="npass" class="h4">Enter New Password</label>
                                    <input type="password" name="npass" class="form-control pb-3" id="myInput1" placeholder="new password" required autocomplete="off"><span class="ti-eye" onclick="myFunction1()"> Show Password</span>
                                   </div>  
                                   ...
                                   <button type="submit" name="submit" class="btn btn-success btn-lg btn-block">SAVE</button>
